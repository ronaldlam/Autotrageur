...
setup(
    ...
    # version='1.0.0',  # Superceded by setuptools_scm implementation below.

    # See https://pypi.org/project/setuptools_scm/
    ...
    description='The automated arbitrageur.',  # Required
    ...
    url='https://github.com/ronaldlam/Autotrageur',  # Optional
    ...
    keywords='trading arbitrage',  # Optional
    ...
    project_urls={  # Optional
        'Issues': 'https://github.com/ronaldlam/Autotrageur/issues',
        'Source': 'https://github.com/ronaldlam/Autotrageur',
    },
)
